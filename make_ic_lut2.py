...
f.writeto("/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_0001.fits",clobber=True)

dc=pilton.heatool("dal_create")
dc["obj_name"]="/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_idx.fits"
dc["template"]="ISGR-LUT2-MOD-IDX.tpl"
remove_withtemplate(dc["obj_name"].value+"("+dc["template"].value+")")
dc.run()

da=pilton.heatool("dal_attach")
da['Parent']="/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_idx.fits"
da['Child1']="/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_0001.fits"
da.run()
...
dv["indol"]="/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_idx.fits"
dv['checksums']="yes"
dv['backpointers']="yes"
dv['detachother']="yes"
dv.run()
...
da['Child1']="/sps/integral/data/ic/ic_snapshot_20140321/ic/ibis/mod/isgri_lut2_mod_idx.fits"
da.run()
