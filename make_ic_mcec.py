...
f[1].header['FILENAME']="isgri_mcec_mod_0001.fits"
f[1].header['LOCATN']="isgri_mcec_mod_0001.fits"
...
f.writeto(ibisicroot+"/isgri_mcec_mod_0001.fits",clobber=True)

dc=pilton.heatool("dal_create")
dc["obj_name"]=ibisicroot+"/isgri_mcec_mod_idx.fits"
dc["template"]="ISGR-MCEC-MOD-IDX.tpl"
remove_withtemplate(dc["obj_name"].value+"("+dc["template"].value+")")
dc.run()

da=pilton.heatool("dal_attach")
da['Parent']=ibisicroot+"/isgri_mcec_mod_idx.fits"
da['Child1']=ibisicroot+"/isgri_mcec_mod_0001.fits"
da.run()
...
dv["indol"]=ibisicroot+"/isgri_mcec_mod_idx.fits"
dv['checksums']="yes"
dv['backpointers']="yes"
dv['detachother']="yes"
dv.run()
...
da['Child1']=ibisicroot+"/isgri_mcec_mod_idx.fits"
da.run()
